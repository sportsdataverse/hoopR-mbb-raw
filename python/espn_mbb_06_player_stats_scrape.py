...
Requirements:
    Uses ``espn_mbb_player_stats_v3`` from sportsdataverse-py, which is the
    site.web.api ``common/v3 .../athletes/{id}/stats`` career endpoint this
    output has always been built from.

    NOT ``espn_mbb_player_stats`` -- despite the name, that is the core-v2
...
# The unsuffixed espn_mbb_player_stats is core-v2 and returns a different
# payload -- see the module docstring. Do not "simplify" this import.
from sportsdataverse.mbb import espn_mbb_player_stats_v3
