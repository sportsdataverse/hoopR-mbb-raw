...
def add_game_to_schedule(schedule):
    ...
    schedule["game_json_url"] = np.where(
        ...
        schedule["game_id"].apply(lambda x: f"https://raw.githubusercontent.com/sportsdataverse/hoopR-mbb-raw/main/mbb/json/final/{x}.json"),
        None
    )
    return schedule
...
def main():
    ...
    for year in years_arr:
        ...
        if args.rescrape == False:
            schedule_in_repo = pd.read_parquet("https://raw.githubusercontent.com/sportsdataverse/hoopR-mbb-data/blob/main/mbb/mbb_games_in_data_repo.parquet",
