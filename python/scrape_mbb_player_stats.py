...
Requirements:
    ...
    invoked with ``league="mens-college-basketball"``. There is no ``sportsdataverse.nba``
...
# Generic basketball player-stats helper; league="mens-college-basketball" builds the
...
def download_player_stats(athlete_id: int, season: int, rerun_existing: bool) -> str:
    ...
    try:
        ...
        raw = _espn_basketball_player_stats(
            league="mens-college-basketball", athlete_id=int(athlete_id), season=int(season), raw=True
        )
